!function(t, e) {
    ...
    , function(t, e, i) {
        ...
        const u = "Live2DFactory"
          ...
          , d = (t, e) => l(void 0, void 0, void 0, (function*() {
            ...
            if ("object" == typeof t.source) {
                ...
                if (i) {
                    ...
                    return t.settings = r,
                    t.live2dModel.emit("settingsLoaded", r),
                    e()
                }
            }
          ...
          , m = (t, e) => l(void 0, void 0, void 0, (function*() {
            ...
            if (i instanceof r.f) {
                ...
                return t.internalModel = r.createInternalModel(o, i, t.options),
                e()
            }
            throw new TypeError("Missing settings.")
        }
        ...
        class _ {
            static registerRuntime(t) {
                _.runtimes.push(t),
                _.runtimes.sort( (t, e) => e.version - t.version)
            }
            ...
            static loadMotion(t, e, i) {
                ...
                try {
                    ...
                    return null !== (o = h[i]) && void 0 !== o || (h[i] = s.a.load({
                        ...
                        return t.emit("motionLoaded", e, i, o),
                        o
                    }
                    ).catch(e => {
            ...
            static loadExpression(t, e) {
                ...
                try {
                    ...
                    return null !== (i = a[e]) && void 0 !== i || (a[e] = s.a.load({
                        ...
                        return t.emit("expressionLoaded", e, s),
                        s
                    }
                    ).catch(e => {
        ...
        _.live2DModelMiddlewares = [h, d, c, g, p, m],
    ...
    , function(t, e, i) {
        ...
        class n {
            ...
            reserve(t, e, i) {
                if (i <= r.NONE)
                    return s.f.log(this.tag, "Cannot start a motion with MotionPriority.NONE."),
                    !1;
                if (t === this.currentGroup && e === this.currentIndex)
                    return s.f.log(this.tag, "Motion is already playing.", this.dump(t, e)),
                    !1;
                if (t === this.reservedGroup && e === this.reservedIndex || t === this.reservedIdleGroup && e === this.reservedIdleIndex)
                    return s.f.log(this.tag, "Motion is already reserved.", this.dump(t, e)),
                    !1;
                if (i === r.IDLE) {
                    if (this.currentPriority !== r.NONE)
                        return s.f.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(t, e)),
                        !1;
                    if (void 0 !== this.reservedIdleGroup)
                        return s.f.log(this.tag, "Cannot start idle motion because another idle motion has reserved.", this.dump(t, e)),
                        !1;
                    this.setReservedIdle(t, e)
                } else {
                    if (i < r.FORCE) {
                        if (i <= this.currentPriority)
                            return s.f.log(this.tag, "Cannot start motion because another motion is playing as an equivalent or higher priority.", this.dump(t, e)),
                            !1;
                        if (i <= this.reservePriority)
                            return s.f.log(this.tag, "Cannot start motion because another motion has reserved as an equivalent or higher priority.", this.dump(t, e)),
                            !1
                    }
            ...
            start(t, e, i, n) {
                if (n === r.IDLE) {
                    ...
                    this.currentPriority !== r.NONE)
                        return s.f.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(e, i)),
                        !1
                } else {
                    if (e !== this.reservedGroup || i !== this.reservedIndex)
                        return s.f.log(this.tag, "Cannot start motion because another motion has taken the place.", this.dump(e, i)),
                        !1;
                    this.setReserved(void 0, void 0, r.NONE)
                }
                return !!t && (this.setCurrent(e, i, n),
                !0)
            }
            complete() {
            ...
            loadExpression(t) {
                return n(this, void 0, void 0, (function*() {
                    ...
                    if (null === this.expressions[t])
                        return void r.f.warn(this.tag, `Cannot set expression at [${t}] because it's already failed in loading.`);
    ...
    , function(t, e, i) {
        ...
        class n {
            ...
            validateFiles(t) {
                ...
                ;
                return [this.moc, ...this.textures].forEach(t => e(t, !0)),
    ...
    , function(t, e, i) {
        ...
        var r, s = i(1), n = i(10), o = i(7), a = i(0), l = i(3), u = function(t, e, i, r) {
            return new (i || (i = Promise))((function(s, n) {
                function o(t) {
                    try {
                        l(r.next(t))
        ...
        class h extends l.EventEmitter {
            ...
            loadMotion(t, e) {
                ...
                return u(this, void 0, void 0, (function*() {
                    if (!(null === (i = this.definitions[t]) || void 0 === i ? void 0 : i[e]))
                        return void a.f.warn(this.tag, `Undefined motion at "${t}"[${e}]`);
                    if (null === this.motionGroups[t][e])
                        return void a.f.warn(this.tag, `Cannot start motion at "${t}"[${e}] because it's already failed in loading.`);
                    if (this.motionGroups[t][e])
                        return this.motionGroups[t][e];
                    const r = yield this._loadMotion(t, e);
                    return this.destroyed ? void 0 : (this.motionGroups[t][e] = null != r ? r : null,
                    r)
                }
                ))
            }
            ...
            startMotion(t, e, i=n.a.NORMAL) {
                var r;
                return u(this, void 0, void 0, (function*() {
                    if (!this.state.reserve(t, e, i))
                        return !1;
                    const n = null === (r = this.definitions[t]) || void 0 === r ? void 0 : r[e];
                    if (!n)
                        return !1;
                    let l;
                    if (this.currentAudio && o.a.dispose(this.currentAudio),
                    s.b.sound) {
                        const t = this.getSoundFile(n);
                        if (t)
                            try {
                                l = o.a.add(this.settings.resolveURL(t), () => this.currentAudio = void 0, () => this.currentAudio = void 0),
                                this.currentAudio = l
                            } catch (e) {
                    ...
                    return this.state.start(u, t, e, i) ? (a.f.log(this.tag, "Start motion:", this.getMotionName(n)),
                ...
                return u(this, void 0, void 0, (function*() {
                    ...
                    if (null == i ? void 0 : i.length) {
                        ...
                        for (let e = 0; e < i.length; e++)
                            null === this.motionGroups[t][e] || this.state.isActive(t, e) || r.push(e);
                        if (r.length) {
            ...
            stopAllMotions() {
                ...
                this.state.reset(),
                this.currentAudio && (o.a.dispose(this.currentAudio),
                this.currentAudio = void 0)
            }
            update(t, e) {
                var i, r;
                this.isFinished() && (this.playing && (this.playing = !1,
                this.emit("motionFinish")),
                this.state.shouldOverrideExpression() && (null === (i = this.expressionManager) || void 0 === i || i.restoreExpression()),
                this.state.complete(),
                this.state.shouldRequestIdleMotion() && this.startRandomMotion(this.groups.idle, n.a.IDLE));
                let s = this.updateParameters(t, e);
                return s = (null === (r = this.expressionManager) || void 0 === r ? void 0 : r.update(t, e)) || s,
                s
            }
            destroy() {
                var t;
                ...
                this.emit("destroy"),
                this.stopAllMotions(),
                null === (t = this.expressionManager) || void 0 === t || t.destroy();
                this.definitions = void 0,
    ...
    , function(t, e, i) {
        ...
        class l extends o.EventEmitter {
            ...
            setupLayout() {
                ...
                this.originalWidth = t[0],
                this.originalHeight = t[1];
    ...
    , function(t, e, i) {
        ...
        class n {
            static createXHR(t, e, i, o, a) {
                ...
                if (n.allXhrSet.add(l),
                t) {
                    let e = n.xhrMap.get(t);
                    e ? e.add(l) : (e = new Set([l]),
                    n.xhrMap.set(t, e)),
                    t.listeners("destroy").includes(n.cancelXHRs) || t.once("destroy", n.cancelXHRs)
                }
                return l.open("GET", e),
                l.responseType = i,
                l.onload = () => {
                ...
                ,
                l.onerror = () => {
                    r.f.warn("XHRLoader", `Failed to load resource as ${l.responseType} (Status ${l.status}): ${e}`),
                ...
                l.onloadend = () => {
                    ...
                    t && (null === (e = n.xhrMap.get(t)) || void 0 === e || e.delete(l))
                }
                ,
                l
            }
    ...
    , function(t, e, i) {
        ...
        class a {
            ...
            set autoInteract(t) {
                t !== this._autoInteract && (t ? this.on("pointertap", l, this) : this.off("pointertap", l, this),
            ...
            registerInteraction(t) {
                ...
                t.on("pointermove", u, this)))
            }
            unregisterInteraction() {
                var t;
                this.interactionManager && (null === (t = this.interactionManager) || void 0 === t || t.off("pointermove", u, this),
        ...
        class f extends n.Container {
            constructor(t) {
                ...
                this.anchor = new o.ObservablePoint(this.onAnchorChange,this,0,0),
                this.glContextID = -1,
            ...
            static fromSync(t, e) {
                const i = new this(e);
                return s.a.setupLive2DModel(i, t, e).then(null == e ? void 0 : e.onLoad).catch(null == e ? void 0 : e.onError),
                i
            }
            ...
            set autoUpdate(t) {
                t ? this._destroyed || (m ? (m.shared.add(this.onTickerUpdate, this),
                this._autoUpdate = !0) : c.f.warn(this.tag, "No Ticker registered, please call Live2DModel.registerTicker(Ticker).")) : (null == m || m.shared.remove(this.onTickerUpdate, this),
                this._autoUpdate = !1)
            }
            init(t) {
            ...
            focus(t, e, i=!1) {
                g.x = t,
                g.y = e,
                this.toModelPosition(g, g, !0),
                this.internalModel.focusController.focus(g.x / this.internalModel.originalWidth * 2 - 1, -(g.y / this.internalModel.originalHeight * 2 - 1), i)
            }
            tap(t, e) {
                const i = this.hitTest(t, e);
                i.length && (c.f.log(this.tag, "Hit", i),
                this.emit("hit", i))
            }
            hitTest(t, e) {
                return g.x = t,
                g.y = e,
                this.toModelPosition(g, g),
                this.internalModel.hitTest(g.x, g.y)
            }
            ...
            _render(t) {
                ...
                for (let i = 0; i < this.textures.length; i++) {
                    ...
                    r.valid && (!e && r.baseTexture._glTextures[this.glContextID] || (t.gl.pixelStorei(WebGLRenderingContext.UNPACK_FLIP_Y_WEBGL, this.internalModel.textureFlipY),
                    t.texture.bind(r.baseTexture, 0)),
                    this.internalModel.bindTexture(i, r.baseTexture._glTextures[this.glContextID].texture),
        ...
        class M {
            ...
            static createSettings(t) {
                return b(this, void 0, void 0, (function*() {
                    ...
                    return o._objectURL = URL.createObjectURL(e),
                    o
                }
                ))
            }
        ...
        M.filesMap = {},
        M.factory = (t, e) => b(void 0, void 0, void 0, (function*() {
            if (Array.isArray(t.source) && t.source[0]instanceof File) {
                ...
                t.live2dModel.once("modelLoaded", t => {
                    t.once("destroy", (function() {
                        ...
                        M.filesMap[t])
                            for (const e of Object.values(M.filesMap[t]))
        ...
        class P {
            static unzip(t, e) {
                return S(this, void 0, void 0, (function*() {
                    const i = yield P.getFilePaths(t)
                      , r = [];
        ...
        P.ZIP_PROTOCOL = "zip://",
        P.uid = 0,
        P.factory = (t, e) => S(void 0, void 0, void 0, (function*() {
            const i = t.source;
            let r, s, n;
            if ("string" == typeof i && (i.endsWith(".zip") || i.startsWith(P.ZIP_PROTOCOL)) ? (r = i.startsWith(P.ZIP_PROTOCOL) ? i.slice(P.ZIP_PROTOCOL.length) : i,
            s = yield v.a.load({
                url: r,
                type: "blob",
                target: t.live2dModel
            })) : Array.isArray(i) && 1 === i.length && i[0]instanceof File && i[0].name.endsWith(".zip") && (s = i[0],
            ...
            s) {
                ...
                n || (n = yield P.createSettings(e)),
                n._objectURL = P.ZIP_PROTOCOL + P.uid + "/" + n.url;
                const i = yield P.unzip(e, n);
                i.settings = n,
                t.source = i,
                r.startsWith("blob:") && t.live2dModel.once("modelLoaded", t => {
                    t.once("destroy", (function() {
    ...
    , function(t, e, i) {
        var r, s = i(59), n = (r = /[^.]+$/.exec(s && s.keys && s.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "";
        t.exports = function(t) {
            return !!n && n in t
        }
    }
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e, i, u) {
            ...
            for (t === e && (e = a(e)),
            i && (g = r(t, o(i))); ++d < c; )
                for (var p = 0, m = e[d], f = i ? i(m) : m; (p = h(g, f, p, u)) > -1; )
                    g !== t && l.call(g, p, 1),
                    l.call(t, p, 1);
            return t
        }
        ...
        t.exports = function(t, e, i, o, a, l) {
            ...
            l.set(e, t); ++p < h; ) {
                var _ = t[p]
                  , v = e[p];
                if (o)
                    var x = u ? o(v, _, p, e, t, l) : o(_, v, p, t, e, l);
                if (void 0 !== x) {
                    if (x)
                        continue;
                    m = !1;
    ...
    , function(t, e, i) {
        ...
        class m {
            static startUp(t) {
                if (h)
                    return v("CubismFramework.startUp() is already done."),
                    h;
                ...
                return v("CubismFramework.startUp() is complete."),
                h
            }
            static cleanUp() {
                h = !1,
            ...
            static initialize() {
                h ? d ? x("CubismFramework.initialize() skipped, already initialized.") : (d = !0,
                v("CubismFramework.initialize() is complete.")) : x("CubismFramework is not started.")
            }
            static dispose() {
                h ? d ? (l.staticRelease(),
                d = !1,
                v("CubismFramework.dispose() is complete.")) : x("CubismFramework.dispose() skipped, not initialized.") : x("CubismFramework is not started.")
            }
            static isStarted() {
                return h
            }
        ...
        class M {
            ...
            updateParameters(t, e, i) {
                ...
                let r = this._weight;
                r = r * (0 == this._fadeInSeconds ? 1 : o.getEasingSine((i - e.getFadeInStartTime()) / this._fadeInSeconds)) * (0 == this._fadeOutSeconds || e.getEndTime() < 0 ? 1 : o.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds)),
                e.setState(i, r),
                f(0 <= r && r <= 1),
        ...
        class w {
            ...
            doUpdateMotion(t, e) {
                ...
                for (; r < this._motions.length; ) {
                    ...
                    s.isFinished() ? (s.release(),
                    this._motions.splice(r, 1)) : (s.isTriggeredFadeOut() && s.startFadeOut(s.getFadeOutSeconds(), e),
                    r++)
                }
                return i
            }
        ...
        class T extends s.a {
            constructor(t, e) {
                ...
                this.definitions = null !== (i = t.expressions) && void 0 !== i ? i : [],
                this.init()
            }
            isFinished() {
                ...
                this.motions)
                    for (const [e,i] of Object.entries(this.motions))
                        for (let r = 0; r < i.length; r++)
                            ...
                            void 0 !== i[r].Sound && (i[r].Sound = t(i[r].Sound, `motions.${e}[${r}].Sound`));
                if (this.expressions)
        ...
        function z(t, e, i) {
            const r = new R;
            return r.time = t.time + (e.time - t.time) * i,
        ...
        function q(t, e, i) {
            ...
            for (let e = r.baseSegmentIndex; e < n; ++e)
                if (o = t.segments[e].basePointIndex + (t.segments[e].segmentType == O.CubismMotionSegmentType_Bezier ? 3 : 1),
                t.points[o].time > i) {
                    s = e;
                    break
                }
        ...
        class H extends M {
            ...
            doUpdateParameters(t, e, i, r) {
                ...
                let l = 0
                  , u = 0;
                this._eyeBlinkParameterIds.length > 64 && _("too many eye blink targets : {0}", this._eyeBlinkParameterIds.length),
                this._lipSyncParameterIds.length > 64 && _("too many lip sync targets : {0}", this._lipSyncParameterIds.length);
                ...
                for (g = 0; g < this._motionData.curveCount && f[g].type == A.CubismMotionCurveTarget_Model; ++g)
                    c = q(this._motionData, g, m),
                    f[g].id == this._modelCurveIdEyeBlink ? a = c : f[g].id == this._modelCurveIdLipSync && (n = c);
                for (; g < this._motionData.curveCount && f[g].type == A.CubismMotionCurveTarget_Parameter; ++g) {
                    if (p = t.getParameterIndex(f[g].id),
                    -1 == p)
                        continue;
                    const s = t.getParameterValueByIndex(p);
                    if (c = q(this._motionData, g, m),
                    a != Number.MAX_VALUE)
                    ...
                    let _;
                    if (f[g].fadeInTime < 0 && f[g].fadeOutTime < 0)
                        _ = s + (c - s) * i;
                    else {
                        let t, i;
                        t = f[g].fadeInTime < 0 ? h : 0 == f[g].fadeInTime ? 1 : o.getEasingSine((e - r.getFadeInStartTime()) / f[g].fadeInTime),
                        i = f[g].fadeOutTime < 0 ? d : 0 == f[g].fadeOutTime || r.getEndTime() < 0 ? 1 : o.getEasingSine((r.getEndTime() - e) / f[g].fadeOutTime),
                ...
                for (; g < this._motionData.curveCount && f[g].type == A.CubismMotionCurveTarget_PartOpacity; ++g)
                    p = t.getParameterIndex(f[g].id),
                    -1 != p && (c = q(this._motionData, g, m),
                    t.setParameterValueByIndex(p, c));
                s >= this._motionData.duration && (this._isLoop ? (r.setStartTime(e),
                this._isLoopFadeIn && r.setFadeInStartTime(e)) : (this._onFinishedMotion && this._onFinishedMotion(this),
                r.setIsFinished(!0))),
                this._lastWeight = i
            }
            setIsLoop(t) {
            ...
            setParameterFadeInTime(t, e) {
                ...
                for (let r = 0; r < this._motionData.curveCount; ++r)
                    if (t == i[r].id)
                        return void (i[r].fadeInTime = e)
            }
            setParameterFadeOutTime(t, e) {
                const i = this._motionData.curves;
                for (let r = 0; r < this._motionData.curveCount; ++r)
                    if (t == i[r].id)
                        return void (i[r].fadeOutTime = e)
            }
            ...
            parse(t) {
                ...
                for (let t = 0; t < this._motionData.curveCount; ++t) {
                    ...
                    i.id = e.getMotionCurveId(t),
                    i.baseSegmentIndex = n;
                    ...
                    for (let r = 0; r < e.getMotionCurveSegmentCount(t); ) {
                        switch (0 == r ? (this._motionData.segments[n].basePointIndex = s,
                        this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r),e.getMotionCurveSegment(t, r + 1)),
                        s += 1,
                        r += 2) : this._motionData.segments[n].basePointIndex = s - 1,
                        e.getMotionCurveSegment(t, r)) {
                        case O.CubismMotionSegmentType_Linear:
                            this._motionData.segments[n].segmentType = O.CubismMotionSegmentType_Linear,
                            this._motionData.segments[n].evaluate = G,
                            this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r + 1),e.getMotionCurveSegment(t, r + 2)),
                            s += 1,
                            r += 3;
                            break;
                        case O.CubismMotionSegmentType_Bezier:
                            this._motionData.segments[n].segmentType = O.CubismMotionSegmentType_Bezier,
                            this._motionData.segments[n].evaluate = X,
                            this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r + 1),e.getMotionCurveSegment(t, r + 2)),
                            this._motionData.points[s + 1] = new R(e.getMotionCurveSegment(t, r + 3),e.getMotionCurveSegment(t, r + 4)),
                            this._motionData.points[s + 2] = new R(e.getMotionCurveSegment(t, r + 5),e.getMotionCurveSegment(t, r + 6)),
                            s += 3,
                            r += 7;
                            break;
                        ...
                        case O.CubismMotionSegmentType_InverseStepped:
                            this._motionData.segments[n].segmentType = O.CubismMotionSegmentType_InverseStepped,
                            this._motionData.segments[n].evaluate = Y,
                            this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r + 1),e.getMotionCurveSegment(t, r + 2)),
                            s += 1,
                            r += 3;
                            break;
        ...
        class Z extends B.a {
            constructor(t, e) {
                ...
                this.queueManager = new w,
                this.definitions = null !== (i = t.motions) && void 0 !== i ? i : {},
            ...
            init(t) {
                super.init(t),
                this.settings.expressions && (this.expressionManager = new T(this.settings,t)),
            ...
            createMotion(t, e, i) {
                ...
                return r.setFadeInTime(i.FadeInTime > 0 ? i.FadeInTime : s),
        ...
        class tt {
            constructor(t) {
                ...
                this._userTimeSeconds = 0,
                this._parameterIds = [],
                null != t && (this._parameterIds = null !== (i = null === (e = t.getEyeBlinkParameters()) || void 0 === e ? void 0 : e.slice()) && void 0 !== i ? i : this._parameterIds)
            }
            static create(t) {
                return new tt(t)
            }
            ...
            updateParameters(t, e) {
                ...
                case et.EyeState_Closing:
                    r = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closingSeconds,
                    r >= 1 && (r = 1,
                ...
                case et.EyeState_Closed:
                    r = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closedSeconds,
                    r >= 1 && (this._blinkingState = et.EyeState_Opening,
                    this._stateStartTimeSeconds = this._userTimeSeconds),
                    i = 0;
                    break;
                case et.EyeState_Opening:
                    r = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._openingSeconds,
                    r >= 1 && (r = 1,
                ...
                case et.EyeState_Interval:
                    this._nextBlinkingTime < this._userTimeSeconds && (this._blinkingState = et.EyeState_Closing,
                    this._stateStartTimeSeconds = this._userTimeSeconds),
                    i = 1;
                    break;
        ...
        class at {
            ...
            release() {
                ...
                for (let e = 0; e < this._clippingContextListForMask.length; e++)
                    this._clippingContextListForMask[e] && (null === (t = this._clippingContextListForMask[e]) || void 0 === t || t.release());
                r._clippingContextListForMask = void 0,
                r._clippingContextListForDraw = void 0,
                this._maskTexture && (null === (e = this.gl) || void 0 === e || e.deleteFramebuffer(this._maskTexture.texture),
                r._maskTexture = void 0),
                r._channelColors = void 0,
                null === (i = this.gl) || void 0 === i || i.deleteTexture(this._colorBuffer),
                this._colorBuffer = null
            }
            initialize(t, e, i, r) {
                for (let t = 0; t < e; t++) {
            ...
            setupClippingContext(t, e) {
                ...
                for (let e = 0; e < this._clippingContextListForMask.length; e++) {
                    ...
                    this.calcClippedDrawTotalBounds(t, r),
                    r._isUsing && i++
                }
                if (i > 0) {
                    ...
                    for (let i = 0; i < this._clippingContextListForMask.length; i++) {
                        ...
                        for (let i = 0; i < h; i++) {
                            ...
                            t.getDrawableDynamicFlagVertexPositionsDidChange(n) && (e.setIsCulling(0 != t.getDrawableCulling(n)),
                            e.setClippingContextBufferForMask(s),
                            e.drawMesh(t.getDrawableTextureIndices(n), t.getDrawableVertexIndexCount(n), t.getDrawableVertexCount(n), t.getDrawableVertexIndices(n), t.getDrawableVertices(n), t.getDrawableVertexUvs(n), t.getDrawableOpacity(n), r.CubismBlendMode_Normal, !1))
                        }
                    }
                    this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, ot),
                ...
                for (let t = 0; t < 4; t++) {
                    ...
                    if (0 == s)
                        ...
                        for (let e = 0; e < s; e++) {
                            ...
                            s._layoutBounds.x = .5 * i,
                            s._layoutBounds.y = 0,
                            s._layoutBounds.width = .5,
                        ...
                        for (let e = 0; e < s; e++) {
                            ...
                            n._layoutBounds.x = .5 * i,
                            n._layoutBounds.y = .5 * s,
                            n._layoutBounds.width = .5,
                            n._layoutBounds.height = .5
                        }
                    else if (s <= 9)
                        for (let e = 0; e < s; e++) {
                            let i = e % 3
                        ...
                        y("not supported mask count : {0}", s)
                }
            }
            getColorBuffer() {
        ...
        class ht {
            ...
            setupShaderProgram(t, e, i, s, n, o, a, l, u, h, d, c, g) {
                ...
                if (null != v) {
                    ...
                    this.gl.uniformMatrix4fv(t.uniformClipMatrixLocation, !1, v._matrixForMask.getArray());
                    ...
                    default:
                        l = this._shaderSets[dt.ShaderNames_NormalPremultipliedAlpha + n],
                        p = this.gl.ONE,
                    ...
                    case r.CubismBlendMode_Additive:
                        l = this._shaderSets[dt.ShaderNames_AddPremultipliedAlpha + n],
                        p = this.gl.ONE,
                        m = this.gl.ONE,
                        f = this.gl.ZERO,
                        _ = this.gl.ONE;
                    ...
                    case r.CubismBlendMode_Multiplicative:
                        l = this._shaderSets[dt.ShaderNames_MultPremultipliedAlpha + n],
                        p = this.gl.DST_COLOR,
                        m = this.gl.ONE_MINUS_SRC_ALPHA,
                        f = this.gl.ZERO,
                        _ = this.gl.ONE
                    }
                    if (this.gl.useProgram(l.shaderProgram),
                    null == a.vertex && (a.vertex = this.gl.createBuffer()),
                    this.gl.bindBuffer(this.gl.ARRAY_BUFFER, a.vertex),
                    this.gl.bufferData(this.gl.ARRAY_BUFFER, s, this.gl.DYNAMIC_DRAW),
                    ...
                    null != i) {
                        ...
                        this.gl.uniformMatrix4fv(l.uniformClipMatrixLocation, !1, i._matrixForDraw.getArray());
                    ...
                    this.gl.uniformMatrix4fv(l.uniformMatrixLocation, !1, c.getArray()),
                ...
                this.gl.bufferData(this.gl.ELEMENT_ARRAY_BUFFER, n, this.gl.DYNAMIC_DRAW),
                this.gl.blendFuncSeparate(p, m, f, _)
            }
            ...
            generateShaders() {
                ...
                this._shaderSets[0].shaderProgram = this.loadShaderProgram(ct, gt),
                this._shaderSets[1].shaderProgram = this.loadShaderProgram(pt, ft),
                this._shaderSets[2].shaderProgram = this.loadShaderProgram(mt, _t),
                this._shaderSets[3].shaderProgram = this.loadShaderProgram(mt, vt),
            ...
            loadShaderProgram(t, e) {
                ...
                if (!r)
                    return y("Vertex shader compile error!"),
                    0;
                let s = this.compileShaderSource(this.gl.FRAGMENT_SHADER, e);
                if (!s)
                    return y("Vertex shader compile error!"),
                    0;
                return this.gl.attachShader(i, r),
                this.gl.attachShader(i, s),
                this.gl.linkProgram(i),
                this.gl.getProgramParameter(i, this.gl.LINK_STATUS) ? (this.gl.deleteShader(r),
                this.gl.deleteShader(s),
                i) : (y("Failed to link program: {0}", i),
            ...
            compileShaderSource(t, e) {
                ...
                if (this.gl.shaderSource(r, i),
                this.gl.compileShader(r),
                !r) {
                    y("Shader compile log: {0} ", this.gl.getShaderInfoLog(r))
                }
                return this.gl.getShaderParameter(r, this.gl.COMPILE_STATUS) ? r : (this.gl.deleteShader(r),
                null)
            }
            setGl(t) {
                this.gl = t
        ...
        class xt extends l {
            ...
            initialize(t) {
                t.isUsingMasking() && (this._clippingManager = new at,
            ...
            release() {
                ...
                null === (t = this.gl) || void 0 === t || t.deleteBuffer(this._bufferData.vertex),
                this._bufferData.vertex = null,
                null === (e = this.gl) || void 0 === e || e.deleteBuffer(this._bufferData.uv),
                this._bufferData.uv = null,
                null === (i = this.gl) || void 0 === i || i.deleteBuffer(this._bufferData.index),
            ...
            drawMesh(t, e, i, r, s, n, o, a, l) {
                ...
                null == this.getClippingContextBufferForMask() && (u.A *= o,
                this.isPremultipliedAlpha() && (u.R *= u.A,
                u.G *= u.A,
                u.B *= u.A));
                let h = null;
                null != this._textures[t] && (h = this._textures[t]),
                ht.getInstance().setupShaderProgram(this, h, i, s, r, n, this._bufferData, o, a, u, this.isPremultipliedAlpha(), this.getMvpMatrix(), l),
        ...
        class Pt extends J.a {
            ...
            init() {
                var t;
                super.init(),
                (null === (t = this.settings.getEyeBlinkParameters()) || void 0 === t ? void 0 : t.length) > 0 && (this.eyeBlink = tt.create(this.settings)),
                this.breath.setParameters([new K(this.idParamAngleX,0,15,6.5345,.5), new K(this.idParamAngleY,0,8,3.5345,.5), new K(this.idParamAngleZ,0,10,5.5345,.5), new K(this.idParamBodyAngleX,0,4,15.5345,.5), new K(this.idParamBreath,0,.5,3.2345,.5)]),
            ...
            getDrawableVertices(t) {
                ...
                for (let t = 0; t < e.length; t += 2)
                    ...
                    e[t + 1] = -e[t + 1] * this.pixelsPerUnit + this.originalHeight / 2;
                return e
            }
            updateTransform(t) {
            ...
            update(t, e) {
                ...
                n.saveParameters(),
                o || null === (i = this.eyeBlink) || void 0 === i || i.updateParameters(n, t),
                this.updateFocus(),
                this.updateNaturalMovements(1e3 * t, 1e3 * e),
                null === (r = this.physics) || void 0 === r || r.evaluate(n, t),
                null === (s = this.pose) || void 0 === s || s.updateParameters(n, t),
            ...
            return m.isStarted() ? Promise.resolve() : (null != Ct || (Ct = new Promise( (t, e) => {
                !function i() {
                    try {
                        ...
                        E.f.log("Cubism4", "Startup failed, retrying 10ms later..."),
                        setTimeout(i, 10)
                    }
                }()
            }
        ...
        class Et {
            ...
            doFade(t, e, i, r) {
                ...
                for (let e = i; e < i + r; ++e) {
                    ...
                    if (s == e)
                        t.setPartOpacityByIndex(i, n);
                    else {
                        let e, r = t.getPartOpacityByIndex(i);
                        e = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5,
                        (1 - e) * (1 - n) > .15 && (e = 1 - .15 / (1 - n)),
                        r > e && (r = e),
        ...
        class Ft {
            ...
            setPartOpacityByIndex(t, e) {
                t in this._notExistPartOpacities ? this._notExistPartOpacities[t] = e : (f(0 <= t && t < this.getPartCount()),
            ...
            getPartOpacityByIndex(t) {
                return t in this._notExistPartOpacities ? this._notExistPartOpacities[t] : (f(0 <= t && t < this.getPartCount()),
            ...
            getParameterValueByIndex(t) {
                return t in this._notExistParameterValues ? this._notExistParameterValues[t] : (f(0 <= t && t < this.getParameterCount()),
            ...
            setParameterValueByIndex(t, e, i=1) {
                t in this._notExistParameterValues ? this._notExistParameterValues[t] = 1 == i ? e : this._notExistParameterValues[t] * (1 - i) + e * i : (f(0 <= t && t < this.getParameterCount()),
        ...
        class jt {
            constructor() {
                this.destination = {},
                this.translationScale = new n(0,0)
            }
        }
        class Nt {
            constructor() {
        ...
        class zt {
            ...
            evaluate(t, e) {
                ...
                const l = new n;
                let u, h, d, c, g, p, m, f;
                g = t.getModel().parameters.values,
                ...
                for (let _ = 0; _ < this._physicsRig.subRigCount; ++_) {
                    ...
                    for (let e = 0; e < u.inputCount; ++e)
                        r = h[e].weight / 100,
                        -1 == h[e].sourceParameterIndex && (h[e].sourceParameterIndex = t.getParameterIndex(h[e].source.id)),
                        h[e].getNormalizedParameterValue(l, i, g[h[e].sourceParameterIndex], m[h[e].sourceParameterIndex], p[h[e].sourceParameterIndex], f[h[e].sourceParameterIndex], u.normalizationPosition, u.normalizationAngle, h[e].reflect, r);
                    s = o.degreesToRadian(-i.angle),
                    l.x = l.x * o.cos(s) - l.y * o.sin(s),
                    l.y = l.x * o.sin(s) + l.y * o.cos(s),
                    te(c, u.particleCount, l, i.angle, this._options.wind, .001 * u.normalizationPosition.maximum, e, 5);
                    for (let e = 0; e < u.outputCount; ++e) {
                        const i = d[e].vertexIndex;
                        if (i < 1 || i >= u.particleCount)
                            break;
                        -1 == d[e].destinationParameterIndex && (d[e].destinationParameterIndex = t.getParameterIndex(d[e].destination.id));
                        const r = new n;
                        r.x = c[i].position.x - c[i - 1].position.x,
                        r.y = c[i].position.y - c[i - 1].position.y,
                        a = d[e].getValue(r, c, i, d[e].reflect, this._options.gravity);
            ...
            parse(t) {
                ...
                for (let t = 0; t < this._physicsRig.subRigCount; ++t) {
                    const n = new kt;
                    n.normalizationPosition.minimum = e.getNormalizationPositionMinimumValue(t),
                    n.normalizationPosition.maximum = e.getNormalizationPositionMaximumValue(t),
                    n.normalizationPosition.defalut = e.getNormalizationPositionDefaultValue(t),
                    n.normalizationAngle.minimum = e.getNormalizationAngleMinimumValue(t),
                    n.normalizationAngle.maximum = e.getNormalizationAngleMaximumValue(t),
                    n.normalizationAngle.defalut = e.getNormalizationAngleDefaultValue(t),
                    n.inputCount = e.getInputCount(t),
                    n.baseInputIndex = i,
                    i += n.inputCount;
                    for (let i = 0; i < n.inputCount; ++i) {
                        const r = new Ut;
                        switch (r.sourceParameterIndex = -1,
                        ...
                        case "Angle":
                            ...
                            r.getNormalizedParameterValue = Yt
                        }
            ...
            initialize() {
                ...
                for (let r = 0; r < this._physicsRig.subRigCount; ++r) {
                    ...
                    t[0].lastPosition = new n(t[0].initialPosition.x,t[0].initialPosition.y),
                    ...
                    for (let r = 1; r < e.particleCount; ++r)
                        i = new n(0,0),
                        i.y = t[r].radius,
                        t[r].initialPosition = new n(t[r - 1].initialPosition.x + i.x,t[r - 1].initialPosition.y + i.y),
                        t[r].position = new n(t[r].initialPosition.x,t[r].initialPosition.y),
                        t[r].lastPosition = new n(t[r].initialPosition.x,t[r].initialPosition.y),
        ...
        function $t(t, e, i, r, s) {
            let n;
            return s = i >= 2 ? e[i - 1].position.substract(e[i - 2].position) : s.multiplyByScaler(-1),
        ...
        function te(t, e, i, r, s, a, l, u) {
            let h, d, c, g, p = new n(0,0), m = new n(0,0), f = new n(0,0), _ = new n(0,0);
            t[0].position = new n(i.x,i.y),
            h = o.degreesToRadian(r),
            g = o.radianToDirection(h),
            g.normalize();
            for (let i = 1; i < e; ++i)
                t[i].force = g.multiplyByScaler(t[i].acceleration).add(s),
                t[i].lastPosition = new n(t[i].position.x,t[i].position.y),
                d = t[i].delay * l * 30,
                p = t[i].position.substract(t[i - 1].position),
                c = o.directionToRadian(t[i].lastGravity, g) / u,
                p.x = o.cos(c) * p.x - p.y * o.sin(c),
                p.y = o.sin(c) * p.x + p.y * o.cos(c),
                t[i].position = t[i - 1].position.add(p),
                ...
                0 != d && (t[i].velocity = t[i].position.substract(t[i].lastPosition),
                t[i].velocity = t[i].velocity.divisionByScalar(d),
                t[i].velocity = t[i].velocity.multiplyByScaler(t[i].mobility)),
                t[i].force = new n(0,0),
                t[i].lastGravity = new n(g.x,g.y)
        }
        function ee(t, e, i, r, s) {
            let n, o, a;
            n = s.getScale(s.translationScale, s.angleScale),
            o = r * n,
            o < e ? (o < s.valueBelowMinimum && (s.valueBelowMinimum = o),
            o = e) : o > i && (o > s.valueExceededMaximum && (s.valueExceededMaximum = o),
            o = i),
            a = s.weight / 100,
            a >= 1 || (o = t[0] * (1 - a) + o * a),
            t[0] = o
        ...
        Lt.a.registerRuntime({
            ...
            createInternalModel(t, e, i) {
                const r = new Pt(t,e,i)
                  , s = t;
                return s.__moc && (r.__moc = s.__moc,
                delete s.__moc,
                r.once("destroy", re)),
                r
            },
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e) {
            var i = n(t)
              ...
              , m = p.length;
            for (var f in t)
                !e && !u.call(t, f) || g && ("length" == f || d && ("offset" == f || "parent" == f) || c && ("buffer" == f || "byteLength" == f || "byteOffset" == f) || a(f, m)) || p.push(f);
            return p
        }
    }
    , function(t, e) {
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e, i, g, p, m) {
            ...
            if (M && !y)
                return m || (m = new r),
                f || h(t) ? s(t, e, i, g, p, m) : n(t, e, v, i, g, p, m);
            if (!(1 & i)) {
        ...
        t.exports = function(t, e, i, n, o, a) {
            ...
            for (var f = l; ++d < h; ) {
                var _ = t[c = u[d]]
                  , v = e[c];
                if (n)
                    var x = l ? n(v, _, c, e, t, a) : n(_, v, c, t, e, a);
    ...
    , function(t, e, i) {
        ...
        function s(t, e) {
            ...
            var i = function() {
                ...
                return i.cache = n.set(s, o) || n,
                o
            };
            return i.cache = new (s.Cache || r),
            i
        }
        s.Cache = r,
        t.exports = s
